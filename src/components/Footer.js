        ...
        <>
            <footer>
                <div className="container-fluid px-5 pt-5">
                    <div className="row ps-md-1">
                        <div className="col-6 col-lg-4 ps-md-5 d-flex justify-content-center   ">
                            <div>
                                <div className="col-12 d-flex fb">
                                    <h1 className='ftouraza'>Digix</h1>
                                </div>
                                <div className="finfo">
                                    <p className='faddress fsm'>5th floor,700/D kings road,green lane New York-1782</p>
                                    <p className='fsm'>+10 367 826 2567</p>
                                    <p className='fsm'>contact@digix.com</p>
                                </div>
                        ...
                        <div className="col-6 col-lg-2 mt-4 fc d-flex justify-content-lg-center">
                            <div className=''>
                                <h4 className='flg'>Pages</h4>
                                <p className='fsm'>Home</p>
                                <p className='fsm'>About</p>
                                <p className='fsm'>Courses</p>
                                <p className='fsm'>Fee</p>
                                <p className='fsm'>Contact</p>
                            </div>
                        </div>
                        <div className="d-none d-lg-block col-4 col-md-2 mt-4 fc d-flex justify-content-center">
                            <div>
                                <h4 className='flg'>Popular Courses</h4>
                                <p className='fsm'>Web Development</p>
                                <p className='fsm'>Digital Marketing</p>
                                <p className='fsm'>Graphic Designing</p>
                                <p className='fsm'>Artificial Intelligence</p>
                                <p className='fsm'>English Spoken</p>
                            </div>
                        </div>
                    </div>
